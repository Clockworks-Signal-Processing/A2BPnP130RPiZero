...
A2B_COMMCH_RET 	adi_a2b_app_CommChSetFraming(int16 nNodeAddr, A2B_COMMCH_FRAMING eFraming);
A2B_COMMCH_RET 	adi_a2b_app_CommChGetFraming(int16 nNodeAddr, A2B_COMMCH_FRAMING *peFraming);
A2B_COMMCH_RET 	adi_a2b_app_CommChMstrSetFraming(int16 nNodeAddr, A2B_COMMCH_FRAMING eFraming);
A2B_COMMCH_RET 	adi_a2b_app_CommChMstrGetFraming(int16 nNodeAddr);
A2B_COMMCH_RET 	adi_a2b_app_CommChSendMsg(uint8 nMsgId, uint16 nMsgLenInBytes, uint8* pMsgPayload, int16 nNodeAddr);
void 			adi_a2b_app_CommChCallBk(uint8 nMsgId, uint16 nMsgLenInBytes, uint8* pMsgPayload, int16 nNodeAddr, A2B_COMMCH_EVENT eEventType, A2B_COMMCH_FRAMING eFraming);
void 			adi_a2b_app_CommChIntQuery(void);
