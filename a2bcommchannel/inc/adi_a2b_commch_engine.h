...
typedef enum A2B_COMMCH_RET
{
	...
	A2B_COMMCH_RET_TXBUSY				/*!< Transmit state busy indicator */
} A2B_COMMCH_RET;
...
typedef enum A2B_COMMCH_EVENT
{
	...
	A2B_COMMCH_EVENT_SET_FRAMING_SUCCESS,	/*!< Setting framing for comm ch success */
	A2B_COMMCH_EVENT_SET_FRAMING_FAILURE,	/*!< Setting framing for comm ch failed  */
	A2B_COMMCH_EVENT_GET_FRAMING_SUCCESS,	/*!< Getting framing for comm ch success */
	A2B_COMMCH_EVENT_GET_FRAMING_FAILURE,	/*!< Getting framing for comm ch failed  */
}A2B_COMMCH_EVENT;

/*! \enum A2B_COMMCH_FRAMING
Enumeration for A2B Comm Channel enable/disable framing
*/
typedef enum A2B_COMMCH_FRAMING
{
    A2B_COMMCH_FRAMING_ENABLED,                 /*!< CommCh framing enabled */
    A2B_COMMCH_FRAMING_DISABLED,                /*!< CommCh framing disabled */
	A2B_COMMCH_FRAMIMG_UNKNOWN					/*!< CommCh framing unknown */
} A2B_COMMCH_FRAMING;
...
typedef void (*pfCommChStatusCb)(void* pCbParam, a2b_CommChMsg *pMsg, A2B_COMMCH_EVENT eEventType, a2b_Int8 nNodeAddr);
