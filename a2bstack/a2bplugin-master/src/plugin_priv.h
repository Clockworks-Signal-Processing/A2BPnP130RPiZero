...
typedef struct a2b_PluginDiscovery
{
    ...
    */
    ...
    /** Flag to indicate whether blind discovery is in process
     */
    a2b_UInt8                    PnPNodeDiscState;
    /** Flag to indicate whether Optimal response cycle calculation is in process after successful blind discovery
     */
    a2b_UInt8                    nRespCycleCounter;
#if defined(A2B_FEATURE_OPTIMAL_RESPCYCS)
    a2b_UInt8                    bBDSecondPass;
    a2b_UInt8                    nNodeOptDiscIdx;
#endif
#endif
