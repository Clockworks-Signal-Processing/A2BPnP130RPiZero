...
/* EEPROM content addresses and values for Two step Discovery */
/** EEPROM address for Header */
#define A2B_MODINFO_ID_ADDR                  (0x00)
/** Header value  */
#define A2B_MODINFO_ID_VAL                   (0xAA)
/** EEPROM address for Vendor ID */
#define A2B_MODINFO_VID_ADDR                 (0x01)
/** Vendor ID value  */
#define A2B_MODINFO_VID_VAL                  (0xAD)
/** EEPROM address for Product ID */
#define A2B_MODINFO_PID_ADDR                 (0x03)
/** Product ID value  */
#define A2B_MODINFO_PID_VAL                  (0x37)
/** EEPROM address for Power Configuration */
#define A2B_BLOCK_MODINFO_POWERCONFIG_ADDR   (0x23)
/** Power Configuration value  */
#define A2B_BLOCK_MODINFO_POWERCONFIG        (0x04)
/** First EEPROM address where SW will look for EEPROM content for two step discovery */
#define A2B_FIRST_EEPROM_ADDR                (0x50)
/** Last EEPROM address where SW will look for EEPROM content for two step discovery */
#define A2B_LAST_EEPROM_ADDR                 (0x54)
#endif /* A2B_ENABLE_SUPPORT_TWO_STEP_DISCOVERY */
...
#ifdef A2B_ENABLE_AD244X_SUPPORT
A2B_DSO_PUBLIC void a2b_dscvryCPRegConfig(a2b_Plugin* plugin, a2b_Int16 nodeAddr);
#endif

#ifdef A2B_FEATURE_PARTIAL_DISC
A2B_EXPORT a2b_Int32 a2b_dscvryPartial(a2b_Plugin* plugin);
#endif

A2B_EXPORT a2b_HResult a2b_CheckIfMedOrHighPwrBusPwrdNodePresentInNetwrk(a2b_Plugin* plugin, a2b_Bool *pbIsMedOrHighPwrBusPwrdNodePresent);
A2B_EXPORT void		   a2b_CheckIfAD243xNodePresentInNetwrk(a2b_Plugin* plugin, a2b_Bool *pbIsAD243xNodeNodePresent);
A2B_EXPORT void a2b_CheckIfAD2430_8NodePresentInNetwrk(a2b_Plugin* plugin, a2b_Bool *pbIsAD2430_8NodeNodePresent);
