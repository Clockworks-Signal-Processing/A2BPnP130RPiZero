...
#define A2B_ENABLE_SUPPORT_TWO_STEP_DISCOVERY

#define A2B_CUSTOM_AUTH_TYPE_MEM       0u
#define A2B_CUSTOM_AUTH_TYPE_GPIO      1u
#define A2B_CUSTOM_AUTH_TYPE_MAILBOX   2u

#define A2B_24V_DISCONECT_THRESHOLD    32u

/* Minimum response cycles reduction to start discovery of a new node with unknown cable length */
#define A2B_PNP_RESP_CYCLES_MIN_DIFF (0x4)
/* Maximum allowed difference in the response cycles between two consecutive nodes during calculation of optimal response cycles for node with unknown cable length */
#define A2B_PNP_RESP_CYCLES_MAX_DIFF (0xB)
/* Increment in the last failed response cycle to achieve optimal response cycles for node with unknown cable length */
#define A2B_PNP_RESP_CYCLES_INC_FOR_OPTIMAL (0x2)
