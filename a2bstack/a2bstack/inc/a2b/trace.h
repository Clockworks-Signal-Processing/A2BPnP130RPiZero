...
/*Trace functions to write the output to a file without
 * name of the file and the line number in the output file
 * */
#       define A2B_TRACE9(X) \
            do { \
                a2b_trace0 X; } while ( 0 )

#       define A2B_TRACE10(X) \
            do { \
                a2b_trace2 X; } while ( 0 )
...
#   define A2B_TRACE9(X) do { } while ( 0 )
#   define A2B_TRACE10(X) do { } while ( 0 )
