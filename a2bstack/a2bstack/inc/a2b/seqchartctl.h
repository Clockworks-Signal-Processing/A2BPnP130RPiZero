...
/** Sequence will trace SPI traffic */
#define A2B_SEQ_CHART_LEVEL_SPI     (1u << 12u)

/** Sequence will trace the discovery process AND all I2C
 *  --makes no sense without I2C sequence as well.
 */
#define A2B_SEQ_CHART_LEVEL_DISCOVERY  ((1u << 10u) | A2B_SEQ_CHART_LEVEL_I2C |  A2B_SEQ_CHART_LEVEL_SPI)

/** Sequence will trace the power fault diagnosis process AND all I2C
 *  --makes no sense without I2C sequence as well.
 */
#define A2B_SEQ_CHART_LEVEL_PWR_FAULT  ((1u << 11u) | A2B_SEQ_CHART_LEVEL_I2C | A2B_SEQ_CHART_LEVEL_SPI)
