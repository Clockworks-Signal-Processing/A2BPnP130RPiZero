...
typedef enum {
	...
	/* Invalid SPI length */
	A2B_EC_SPI_INVALID_LENGTH,

	/* SPI to SPI peripheral programming failed */
	A2B_EC_SPITOSPI_PERICONFIG_FAILED,

	/* Ongoing SPI to SPI peripheral transaction error */
	A2B_EC_SPITOSPI_ONGOING_TRANSACTION,
	 ...
	 * - Valid EEPROM is not found
	 * - EEPROM content is not valid */
	A2B_EC_TWOSTEP_DISC_FAILED,

    /* Two step discovery is failed because of Critical fault */
    A2B_EC_TWOSTEP_DISC_CRIT_FAULT,

    /* 24V is disconnected after two step discovery */
    A2B_EC_TWOSTEP_DISC_24V_DISC,
