...
typedef a2b_HResult(A2B_CALL * a2b_SpiInitFunc)(A2B_ECB* ecb);
typedef a2b_Handle(A2B_CALL * a2b_SpiOpenFunc)(A2B_ECB* ecb);
typedef a2b_HResult(A2B_CALL * a2b_SpiCloseFunc)(a2b_Handle hnd);
typedef a2b_HResult(A2B_CALL * a2b_SpiReadFunc)(a2b_Handle hnd, a2b_UInt16 addr, a2b_UInt16 nRead, a2b_Byte* rBuf);
typedef a2b_HResult(A2B_CALL * a2b_SpiWriteFunc)(a2b_Handle hnd, a2b_UInt16 spiSs, a2b_UInt16 nWrite, const a2b_Byte* wBuf);
typedef a2b_HResult(A2B_CALL * a2b_SpiWriteReadFunc)(a2b_Handle hnd, a2b_UInt16 spiSs, a2b_UInt16 nWrite, const a2b_Byte* wBuf, a2b_UInt16 nRead, a2b_Byte* rBuf);
typedef a2b_HResult(A2B_CALL * a2b_SpiFdFunc)(a2b_Handle hnd, a2b_UInt16 addr, a2b_UInt16 nWrite, const a2b_Byte* wBuf, a2b_UInt16 nRead, a2b_Byte* rBuf);
typedef a2b_HResult(A2B_CALL * a2b_SpiShutdownFunc)(A2B_ECB* ecb);
typedef a2b_HResult(A2B_CALL * a2b_SpiFullDuplexFunc)(a2b_Handle hnd, a2b_UInt16 addr, a2b_UInt16 nWrite, const a2b_Byte* wBuf, a2b_UInt16 nRead, a2b_Byte* rBuf);
...
/*----------------------------------------------------------------------------*/
/**
 * \defgroup a2bstack_pal_fileIO           FILEIO Types/Defs
 * \ingroup  a2bstack_pal_def
 *
 ...
 * \{ */
/*----------------------------------------------------------------------------*/
typedef a2b_HResult (A2B_CALL * a2b_FileReadFunc)(a2b_Handle hnd, a2b_UInt16 offset, a2b_UInt16 nRead,
        										  a2b_Byte* rBuf);
/** \} -- a2bstack_pal_log */
 ...
 * PAL plugin data types and definitions.
 *
 * These functions are responsible reading the power good signal required for Two step discovery.
 *
 * \{ */
 /*----------------------------------------------------------------------------*/

typedef void (A2B_CALL* a2b_pal_GetPFSignalFunc)(a2b_Handle hnd, a2b_UInt16 NodeAddr, a2b_Bool* bPresent);
...
typedef struct a2b_StackPal
{
	...
	/** \name SPI Implementation
	*  SPI prototypes requiring platform implementation.
	*
	* \{ */
	a2b_SpiInitFunc         spiInit;
	a2b_SpiOpenFunc         spiOpen;
	a2b_SpiCloseFunc        spiClose;
	a2b_SpiReadFunc         spiRead;
	a2b_SpiWriteFunc        spiWrite;
	a2b_SpiWriteReadFunc    spiWriteRead;
	a2b_SpiFdFunc		    spiFd;
	a2b_SpiFullDuplexFunc   spiFullDuplex;
	a2b_SpiShutdownFunc     spiShutdown;
	/** \} */
    ...
    /** \name Platform Two Step Discovery Implementation
     *  Platform implementation for reading the Power Good signal required for two step discovery.
     *
     * \{ */
    a2b_pal_GetPFSignalFunc getPGSignal;
    /** \} */

    /** \name BCF_From FileIO
     *  Platform implementation for reading the BCF/BDD from FILEIO
     *
     * \{ */
    a2b_FileReadFunc     fileRead;
    /** \} */
