...
typedef union a2b_ContextCtrlBlk
{
    ...
    struct {
    	/* TDB */
    	a2b_UInt32 aCPI2CAddr[A2B_CONF_MAX_NUM_SLAVE_NODES + 1u];
    	/* Flag to disable remote CPE event processing */
    	a2b_UInt8  bDisIntService[A2B_CONF_MAX_NUM_SLAVE_NODES + 1u];
    	a2b_UInt32 nNodesDiscovered;
    } app;
