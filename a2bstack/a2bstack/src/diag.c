        ...
        else
        {
                ...
                (reg == A2B_REG_TESTMODE) )
            {
                ...
                if ( A2B_SUCCEEDED(result) )
                {
                    ...
                    result = a2b_regBroadcastWrite(mCtx,
                                            (a2b_UInt16)A2B_ARRAY_SIZE(wBuf), &wBuf[0]);
                }
            }
            /* Else a write to a single node */
            else
            {
                result = a2b_regWrite(mCtx, nodeAddr,
                		(a2b_UInt16)A2B_ARRAY_SIZE(wBuf), &wBuf[0]);
    ...
    )
{
    ...
    else
    {
        ...
        {
            wBuf[0] = reg;
            result = a2b_regWriteRead(mCtx, nodeAddr,
                                            1u, &wBuf[0u], 1u, value);
    ...
    )
{
    ...
    else
    {
        ...
        else
        {
            ...
            result = a2b_regWriteRead(mCtx, nodeAddr, 1u, &wBuf[0],
                                                       2u, &rBuf[0]);
