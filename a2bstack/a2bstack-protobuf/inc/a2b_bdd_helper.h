...
* @{
*/
A2B_EXPORT void a2b_bcfParse_bdd(ADI_A2B_BCD *pBusDescription,bdd_Network  *bdd_Graph, a2b_UInt8 nBusIndex);
A2B_EXPORT void adi_a2b_ParsePeriCfgTable(ADI_A2B_BCD*  pBusDescription, ADI_A2B_NODE_PERICONFIG aPeriDownloadTable[], a2b_UInt8 nBusIndex);
A2B_EXPORT void adi_a2b_ParsePeriCfgFrComBCF(ADI_A2B_COMPR_BCD*  pBusDescription, ADI_A2B_NODE_PERICONFIG aPeriDownloadTable[], a2b_UInt8 nBusIndex);
A2B_EXPORT a2b_Bool adi_a2b_ComprBcfParse_bdd( ADI_A2B_COMPR_BCD *pCmprBusDescription, bdd_Network  *bdd_Graph, a2b_UInt8 nBusIndex);
A2B_EXPORT a2b_HResult a2b_get_bddFrmE2promOrFileIO(A2B_ECB* ecb, bdd_Network *bdd_Graph, a2b_UInt8* pBuff, a2b_UInt8 pPeriBuf[], ADI_A2B_NETWORK_CONFIG* pTgtProp);
A2B_EXPORT a2b_HResult a2b_get_nChainsFrmE2promFileIO(A2B_ECB* ecb, a2b_UInt8* pNumChains);
/**
 @}
*/
A2B_END_DECLS
